...
public:
    ...
    PhoneKeypad() : UIW_WINDOW(8, 3, 35, 18, WOF_BORDER)
    {
        ...
        *this + display;
        ...
        char *labels[] = {(char *)"1", (char *)"2", (char *)"3", (char *)"4", (char *)"5", (char *)"6",
                         (char *)"7", (char *)"8", (char *)"9", (char *)"*", (char *)"0", (char *)"#"};
        int ids[] = {ID_BTN_1, ID_BTN_2, ID_BTN_3, ID_BTN_4, ID_BTN_5, ID_BTN_6,
                     ID_BTN_7, ID_BTN_8, ID_BTN_9, ID_BTN_STAR, ID_BTN_0, ID_BTN_HASH};
        ...
        *this + new UIW_BUTTON(8, 15, 18, (char *)"Clear", BTF_NO_FLAGS, WOF_JUSTIFY_CENTER,
                               ZIL_NULLF(ZIL_USER_FUNCTION), 200);
    }
